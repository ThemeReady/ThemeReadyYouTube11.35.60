...
.method public constructor <init>(Lhpz;)V
    ...
    iput-object v0, p0, Lhqa;->b:Ljava/io/ByteArrayOutputStream;
...
.method public final a(Lhps;)Z
    ...
    invoke-virtual {v0, p1, v1}, Lhpz;->a(Lhps;Z)Ljava/lang/String;
    ...
    :cond_2
    iget-object v4, p0, Lhqa;->b:Ljava/io/ByteArrayOutputStream;
    ...
    :cond_4
    :try_start_0
    iget-object v0, p0, Lhqa;->b:Ljava/io/ByteArrayOutputStream;
    ...
    iget-object v1, p0, Lhqa;->c:Lhpz;

    const-string v3, "Failed to write payload when batching hits"

    invoke-virtual {v1, v3, v0}, Lhpz;->d(Ljava/lang/String;Ljava/lang/Object;)V

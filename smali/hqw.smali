...
.field private volatile b:Lhpt;

.field private volatile c:Z


# direct methods
.method protected constructor <init>(Lhqu;)V
    .locals 0
...
.method public final a()Lhpt;
    ...
    iget-object v2, p0, Lhqw;->a:Lhqu;

    .line 3000
    iget-object v2, v2, Lhqn;->g:Lhqq;
    ...
    :try_start_0
    iput-object v4, p0, Lhqw;->b:Lhpt;

    const/4 v4, 0x1

    iput-boolean v4, p0, Lhqw;->c:Z

    iget-object v4, p0, Lhqw;->a:Lhqu;

    .line 5000
    iget-object v4, v4, Lhqu;->a:Lhqw;

    .line 0
    const/16 v5, 0x81

    invoke-virtual {v3, v2, v1, v4, v5}, Libq;->a(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    invoke-virtual {v2, v3, v4}, Lhqu;->a(Ljava/lang/String;Ljava/lang/Object;)V

    if-nez v1, :cond_0

    const/4 v1, 0x0

    iput-boolean v1, p0, Lhqw;->c:Z
    ...
    :try_start_2
    iput-boolean v0, p0, Lhqw;->c:Z

    iget-object v0, p0, Lhqw;->b:Lhpt;

    const/4 v1, 0x0

    iput-object v1, p0, Lhqw;->b:Lhpt;
    ...
    invoke-virtual {v1, v2}, Lhqu;->d(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lhqu;->c(Ljava/lang/String;)V
    :try_end_3
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-static {v0}, Lhzd;->b(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lhqu;->d(Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-virtual {v1, v2}, Lhqu;->a(Ljava/lang/String;)V
    :try_end_3
    ...
    invoke-direct {v0, p2}, Lhpv;-><init>(Landroid/os/IBinder;)V
    :try_end_6
    ...
    invoke-virtual {v2, v3, v0}, Lhqu;->d(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_9
    ...
    invoke-virtual {v1, v2}, Lhqu;->c(Ljava/lang/String;)V
    ...
    invoke-direct {v2, p0, v0}, Lhqx;-><init>(Lhqw;Lhpt;)V
...
.method public final onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    invoke-direct {v1, p0, p1}, Lhqy;-><init>(Lhqw;Landroid/content/ComponentName;)V

    invoke-virtual {v0, v1}, Lhsi;->a(Ljava/lang/Runnable;)V
